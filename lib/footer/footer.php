...
<div class="panel-footer footer">
	<footer class="page-footer font-small blue-grey lighten-5 pt-0">
			...
			<div class="container">
				...
				<div class="row py-4 d-flex align-items-center">
					...
					<div class="col-12 col-md-7 text-center text-md-right">
						...
						<!--Twitter-->
						<a class="tw-ic"> <i class="fa fa-twitter white-text mr-lg-4"> </i>
						</a>
						<!--Google +-->
						<a class="gplus-ic"> <i
						...
						<!--Linkedin-->
						<a class="li-ic"> <i class="fa fa-linkedin white-text mr-lg-4"> </i>
						</a>
						<!--Instagram-->
						<a class="ins-ic"> <i class="fa fa-instagram white-text mr-lg-4">
						</i>
						</a>
					</div>
					<!--Grid column-->
			...
			<div class="row mt-3">
				...
				<div class="col-md-4 col-lg-3 col-xl-3 dark-grey-text">
					...
					<hr class="teal accent-3 mb-4 mt-0 d-inline-block mx-auto"
						style="width: 60px;">
					<p>
						<i class="fa fa-home mr-3"></i> Windsor, OH, CA
					</p>
					<p>
						<i class="fa fa-envelope mr-3"></i> info@GreenPharm.com
					</p>
					<p>
		...
		<div class="footer-copyright py-3 text-center">
			© 2018 Copyright: <a href="https://hackinghealth.com"> <strong>
					HackingHealth.com</strong>
			</a>
		</div>
		<!--/.Copyright -->
